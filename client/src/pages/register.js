...
const Register = () => {
  ...
  <div className="row">
    ...
    <img src="https://cdni.iconscout.com/illustration/premium/thumb/task-registration-2081679-1756042.png" className="rounded mx-auto d-block mt-3" alt="..."/>
    </div>
    <div className="col container mt-2">
      <div className="auth_page " >
        <form onSubmit={handleSubmit} style={well} >
         <b> <h3 className="text-uppercase text-center mb-4" style={{fontFamily:'Grand Hotel' ,fontWeight:'bold'  } }>
           Talkline
          </h3></b>
          <div className="mb-3">
            ...
            <div className=" form-input-wrap" style={{backgroundColor:"#BE8C63"}}>
              <input 
                             type="text"
